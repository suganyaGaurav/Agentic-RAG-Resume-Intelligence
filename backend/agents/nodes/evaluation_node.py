# ==========================================
# Title : evaluation_node.py
# Path : backend/agents/nodes/evaluation_node.py
# Purpose: Execute deterministic evaluation logic, after semantic retrieval and analysis.
#
# Responsibilities:
